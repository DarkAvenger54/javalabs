...
{
    MONDAY(2,"key.monday"), TUESDAY(3, "key.tuesday"), WEDNESDAY(4,"key.wednesday"), THURSDAY(5,"key.thursday"), FRIDAY(6,"key.friday"), SATURDAY(7,"key.saturday"), SUNDAY(1,"key.sunday");
    private int id;
    private String key;
